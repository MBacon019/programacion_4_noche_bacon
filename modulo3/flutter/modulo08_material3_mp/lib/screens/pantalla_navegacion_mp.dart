...
class PantallaNavegacionMedica extends StatefulWidget {
  const PantallaNavegacionMedica({super.key});

  @override
  State<PantallaNavegacionMedica> createState() => _PantallaNavegacionMedicaState();
}

class _PantallaNavegacionMedicaState extends State<PantallaNavegacionMedica> {
  int _indice = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Row(children: [
          Expanded(child: _TarjetaMetrica(titulo: 'Pacientes', valor: '8',  icono: Icons.people,        color: cs.primaryContainer)),
          const SizedBox(width: 8),
          Expanded(child: _TarjetaMetrica(titulo: 'Alertas',    valor: '3',  icono: Icons.notifications, color: cs.errorContainer)),
        ]),
        const SizedBox(height: 8),
        Row(children: [
          Expanded(child: _TarjetaMetrica(titulo: 'Ocupación', valor: '99.8%', icono: Icons.trending_up, color: cs.tertiaryContainer)),
          const SizedBox(width: 8),
          Expanded(child: _TarjetaMetrica(titulo: 'Turnos hoy', valor: '12', icono: Icons.calendar_month, color: cs.secondaryContainer)),
        ]),
      ],
    );
  }
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) => Card(
        child: ListTile(
          ...
          subtitle: Text('Sala ${i + 10} · Internado'),
...
class _PantallaAlertas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const alertas = [
      (servidor: 'Paciente Álvarez, T.', mensaje: 'Frecuencia cardíaca elevada',   nivel: 'CRÍTICO'),
      (servidor: 'Paciente Molina, D.',  mensaje: 'Saturación al 85%',             nivel: 'AVISO'),
      (servidor: 'Paciente Ibarra, F.',  mensaje: 'Caída inesperada reportada',    nivel: 'CRÍTICO'),
    ];
