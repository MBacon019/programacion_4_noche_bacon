...
class PantallaContextoMedica extends StatelessWidget {
  const PantallaContextoMedica({super.key});
        ...
        children: [
          ...
          _Seccion(
            ...
            items: [
              ...
              'Padding top:  ${MediaQuery.paddingOf(context).top.toStringAsFixed(0)} px',
              'Pixel ratio:  ${MediaQuery.devicePixelRatioOf(context).toStringAsFixed(1)}  (2.0–3.0 común en emuladores)',
          ...
          ElevatedButton.icon(
            onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('¡Turno registrado correctamente!')),
            ),
