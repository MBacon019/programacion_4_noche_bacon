...
class ContadorPacientes extends StatefulWidget {
  ...
  @override
  State<ContadorPacientes> createState() => _ContadorPacientesState();
}

class _ContadorPacientesState extends State<ContadorPacientes> {
  int _valor = 0;
