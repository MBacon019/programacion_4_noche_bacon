        ...
        child: Row(
          ...
          children: [
            Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              SizedBox(height: 4),
              Text('web-01', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
            ]),
            SizedBox(width: 24),
            Column(mainAxisSize: MainAxisSize.min, children: [
            ]),
            Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              SizedBox(height: 4),
              Text('db-01', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
            ]),
            SizedBox(width: 24),
            Column(mainAxisSize: MainAxisSize.min, children: [
              AvatarBadge(nombre: 'worker', alertas: 0,  activo: false),
              SizedBox(height: 4),
              Text('worker', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
            ]),
            SizedBox(width: 24),
            Column(mainAxisSize: MainAxisSize.min, children: [
              AvatarBadge(nombre: 'cache',  alertas: 11, activo: true),
              SizedBox(height: 4),
              Text('cache', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
            ]),
            SizedBox(width: 24),
            Column(mainAxisSize: MainAxisSize.min, children: [
              AvatarBadge(nombre: 'detalle', alertas: 5,  activo: false),
              SizedBox(height: 4),
              Text('detalle', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
            ]),
